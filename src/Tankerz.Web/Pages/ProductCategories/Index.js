$(function () {
    ...
    var dataTable = $('#ProductCategoriesTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(tankerz.productCategories.productCategory.getList),
            columnDefs: [
                {
                    width: 70,
                    title: l('Image'),
                        ...
                        items:
                            [
                                ...
                                },
                                {
                                    ...
                                    action: function (data) {
                                        tankerz.productCategories.productCategory
