...
{
    [DbContext(typeof(TankerzMigrationsDbContext))]
    [Migration("20210709103920_Create_Tankerz_Entities")]
    partial class Create_Tankerz_Entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tankerz.TankerzEntities.BlogCategories.BlogCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("MetaThumbnail")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppBlogCategories");
                });

            modelBuilder.Entity("Tankerz.TankerzEntities.Blogs.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tankerz.TankerzEntities.ProductGroups.ProductGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tankerz.TankerzEntities.TankerzFiles.TankerzFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppTankerzFiles");
                });

            modelBuilder.Entity("Tankerz.TankerzEntities.TankerzFolders.TankerzFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppTankerzFolders");
                });

            modelBuilder.Entity("Tankerz.TankerzEntities.TankerzPages.TankerzPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Tankerz.TankerzEntities.Blogs.Blog", b =>
                {
                    b.HasOne("Tankerz.TankerzEntities.BlogCategories.BlogCategory", "BlogCategory")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("Tankerz.TankerzEntities.ProductCategories.ProductCategory", b =>
                {
                    b.HasOne("Tankerz.TankerzEntities.ProductCategories.ProductCategory", null)
                        .WithMany("ProductCategories")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("Tankerz.TankerzEntities.ProductGroups.ProductGroup", "ProductGroup")
                        .WithMany("ProductCategories")
